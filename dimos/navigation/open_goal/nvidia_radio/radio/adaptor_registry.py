...
class AdaptorRegistry:
    ...
    def create_adaptor(self, name, main_config: Namespace, adaptor_config: dict_t, state: state_t, **kwargs) -> AdaptorBase:
        if name not in self._registry:
            return GenericAdaptor(main_config, adaptor_config, state)
        return self._registry[name](main_config, adaptor_config, state, **kwargs)
