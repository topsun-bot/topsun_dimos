...
if TYPE_CHECKING:
    ...
    from dimos.navigation.global_planner.evaluator.recording import Frame, Trajectory
...
class Suite:
    ...
    def trajectory(self) -> Trajectory:
        ...
        from dimos.navigation.global_planner.evaluator.recording import load_trajectory
    ...
    def world_frames(self, align_tol: float) -> Iterator[Frame]:
        ...
        from dimos.navigation.global_planner.evaluator.recording import iter_world_frames
