...
def create_patrol_router(name: PatrolRouterName, clearance_radius_m: float) -> PatrolRouter:
    match name:
        case "random":
            ...
            from dimos.navigation.experimental.patrolling.routers.random_patrol_router import (
                RandomPatrolRouter,
            )
        ...
        case "frontier":
            # Inline to avoid unnecessary imports.
            from dimos.navigation.experimental.patrolling.routers.frontier_patrol_router import (
