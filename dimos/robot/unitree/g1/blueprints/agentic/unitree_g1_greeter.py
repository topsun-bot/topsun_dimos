...
"""最小化、笔记本友好的 G1 迎宾蓝图(无移动、无传感器)。

用法::

    dimos --robot-ip 10.10.196.17 --unitree-cloud-region cn run unitree-g1-greeter
    dimos tell "你好"          # 固定迎宾模板,不走 LLM
    dimos tell "厕所在哪"      # 未建图固定拒答(当前 LLM 已关闭)
"""
