...
"""免提语音迎宾蓝图(VAD + 固定模板短路;当前 LLM 已关闭)。

用法::

    dimos --robot-ip 10.10.196.17 --unitree-cloud-region cn run unitree-g1-greeter-hands-free
"""
...
__all__ = ["unitree_g1_greeter_hands_free"]
