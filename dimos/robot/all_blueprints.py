...
all_blueprints = {
    ...
    "unitree-go2-stairs": "dimos.robot.unitree.go2.blueprints.smart.unitree_go2_stairs:unitree_go2_stairs",
    "unitree-go2-stairs-agentic": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_stairs_agentic:unitree_go2_stairs_agentic",
