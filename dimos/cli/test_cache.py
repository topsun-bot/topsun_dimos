...
def test_clean_yes_removes_cache_without_prompting(
    ...
    cleanup_guard.assert_called_once_with()
    clean_caches.assert_called_once_with(force=False)


def test_clean_force_removes_protected_robot_checkouts(
    cache_dir: Path,
    cleanup_guard: MagicMock,
    mocker: MockerFixture,
) -> None:
...
def test_clean_force_does_not_override_active_run(
    cache_dir: Path,
    mocker: MockerFixture,
) -> None:
    cache_dir.mkdir()
...
def test_clean_reports_skipped_robot_checkout_as_partial_failure(
    cache_dir: Path,
    cleanup_guard: MagicMock,
    mocker: MockerFixture,
) -> None:
