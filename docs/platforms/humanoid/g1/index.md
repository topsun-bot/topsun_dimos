...
- DimOS G1 agent demos: `dimos --simulation run unitree-g1-agentic-sim` and `dimos run unitree-g1-agentic --robot-ip 192.168.123.161`. [AGENTS.md](/AGENTS.md), [Horizon taxonomy](/docs/usage/holo_integration.md)
